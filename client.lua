...
function MAKEITZOOM(cam)
    ...
    --Camera 1
RegisterNetEvent("jerry-cameras:picture1", function()
    if not active then
        active = true
                    ...
                    while active and not IsEntityDead(lPed) and (GetVehiclePedIsIn(lPed) == vehicle) and true do
                        ...
                        elseif IsControlJustPressed(1, 176) then
                            if not takethapicbro then
                                takethapicbro = true
                                QBCore.Functions.TriggerCallback("jerry-cameras:webookpd", function(hook)
                                    if hook then
...
RegisterNetEvent("jerry-cameras:picture2", function()
    if not active then
        active = true
        local ped = PlayerPedId()
        SharedRequestAnimDict("amb@world_human_paparazzi@male@base", function()
                ...
                if active then
                    ...
                    while active and not IsEntityDead(lPed) and (GetVehiclePedIsIn(lPed) == vehicle) and true do
                        ...
                        elseif IsControlJustPressed(1, 176) then
                            if not takethapicbro then
                                takethapicbro = true
                                QBCore.Functions.TriggerCallback("jerry-cameras:webookcid", function(hook)
                                    if hook then
                                        exports['screenshot-basic']:requestScreenshotUpload(tostring(hook), "files[]", function()
                                            SharedRequestAnimDict("amb@world_human_paparazzi@male@base", function()
                                                TaskPlayAnim(ped, "amb@world_human_paparazzi@male@base", "exit", 2.0, 2.0, -1, 1, 0, false, false, false)
...
RegisterNetEvent("jerry-cameras:picture3", function()
    if not active then
        active = true
        local ped = PlayerPedId()
        SharedRequestAnimDict("amb@world_human_paparazzi@male@base", function()
                ...
                if active then
                    ...
                    while active and not IsEntityDead(lPed) and (GetVehiclePedIsIn(lPed) == vehicle) and true do
                        ...
                        elseif IsControlJustPressed(1, 176) then
                            if not takethapicbro then
                                takethapicbro = true
                                QBCore.Functions.TriggerCallback("jerry-cameras:webookpi", function(hook)
                                    if hook then
                                        exports['screenshot-basic']:requestScreenshotUpload(tostring(hook), "files[]", function()
                                            SharedRequestAnimDict("amb@world_human_paparazzi@male@base", function()
                                                TaskPlayAnim(ped, "amb@world_human_paparazzi@male@base", "exit", 2.0, 2.0, -1, 1, 0, false, false, false)
